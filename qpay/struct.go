...
const (
	...
	StatusCodeOK           = "Ok"
	StatusCodeNotOk        = "Ng"
	TermInfoCtxKey         = "termInfo"
	AuthorizationHeader    = `^Bearer [A-Za-z0-9]+$`
	BadAuthorization       = "Bad Authorization Header"
	CONTENTTYPE            = "Content-Type"
	APPLICATIONJSON        = "application/json"
	REQUESTID              = "Request-Id"
	BADREQUEST             = "Bad Request"
	CONTEXTACCESSTOKEN     = "Authorization"
	CONTEXTBILLERTANKID    = "BillerTankId"
	MIDDLEWAREBILLERTANKID = "AuthBillerTankId"
	LOGLEVELINFO           = "info"
	POST                   = "POST"
	GET                    = "GET"
	DELETE                 = "DELETE"
	...
	// Constant Errors to LOG Server
	InternalServerError = "Internal Server Error"
	JSONInvalid         = "JSON Body is not valid"
	ValidationErr       = "Request Body Validation Error"
	NoRecordFound       = "There is no record associated"
	SysForbidden        = "Forbidden access"
)
...
type ResponseBuilder struct {
	...
	// Data to Write to Struct Response Handler
	Data interface{} `json:"data"`
}

// Response Exception Builder
type ResponseExceptionBuilder struct {
	Error struct {
		StatusCode int         `json:"status_code"`
